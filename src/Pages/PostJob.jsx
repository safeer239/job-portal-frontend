    ...
    <div className='max-w-screen-2xl container mxx-auto xl:px-24 px-4'> 
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-5'>
            ...
            <div className='create-job-flex'>
                ...
                <div className='lg:w-1/2 w-full'>
                     ...
                     <input type="text" placeholder="Ex:Google or Microsoft" {...register("companyName")} className='create-job-input'/>
                </div>
            </div>
            {/* 2nd */}
            <div className='create-job-flex'>
                ...
                <div className='lg:w-1/2 w-full'>
                     ...
                     <input type="text" placeholder="$35k" {...register("maxPrice")} className='create-job-input'/>
                </div>
            </div>
            {/* 3rd */}
            <div className='create-job-flex'>
        ...
        <option value="Yearly">Yearly</option>
            ...
            <div className='lg:w-1/2 w-full'>
                     ...
                     <input type="date" placeholder="2023-10-23" {...register("postingDate")} className='create-job-input'/>
                </div>
                <div className='lg:w-1/2 w-full'>
        ...
        <option value="Work remotely">Work remotely</option>
            ...
            <label className='block mb-2 text-lg'>Required Skill Sets:</label>
              <CreatableSelect className='create-job-input' defaultValue={selectedOption}
